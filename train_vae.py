...
from model.datasets import ConditionalDataset
...
if __name__ == "__main__":
    ...
    data_train = ConditionalDataset("data/X_train_crop.npy", "data/Y_embedded_train.npy", in_cluster)
    data_test  = ConditionalDataset("data/X_test_crop.npy",  "data/Y_embedded_test.npy", in_cluster)
